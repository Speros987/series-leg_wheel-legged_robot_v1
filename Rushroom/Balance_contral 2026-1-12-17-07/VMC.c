...
void left_vmc()
{
    ...
    x.cos_theta = (sin_alpha*cos_AOB - sin_AOB*cos_alpha)*OB/left_leg.L_tui ;
    x.sin_theta = (l_5*l_5/4 + left_leg.L_tui*left_leg.L_tui - OB*OB)/(l_5*left_leg.L_tui) ;

    x.theta = asinf(x.sin_theta) ;
